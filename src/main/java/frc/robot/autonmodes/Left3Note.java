...
public class Left3Note {
  ...
  public static Command getCommand() {
    ...
    Trajectory trajectory2 = Subsystems.m_driveSubsystem.getTrajectory("Left3NoteBackward");
    Trajectory trajectory3 = Subsystems.m_driveSubsystem.getTrajectory("Left3NoteForward2");
